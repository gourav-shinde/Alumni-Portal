...
class Student(models.Model):
    user = models.Foreignkey(User,on_delete=models.CASCADE)#prefered
#remove the attributes of user model from this class or just assign(copy the values from User model to this model
